...
**[!]** Đây là file những bài tập tớ làm để nộp lên PTIT Code trong quá trình học và luyện tập môn Tin học cơ sở 2 (ngôn ngữ lập trình C) trên PTIT Code (code.ptit.edu.vn).

Trong quá trình làm và để hiểu những bài tập này, tớ có tham khảo nhiều nguồn khác nhau (ChatGPT, Github, 28tech, GeeksforGeeks,...), và cũng để lại comments ở trong file. 
Vì đây có là những bài C code đầu tiên của tớ, những bài này có thể không tránh khỏi được những sai sót, chưa được tối ưu, chưa được gọn hay có những chỗ còn hơi mơ hồ. 
